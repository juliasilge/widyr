...
We may then be interested in obtaining a measure of country-to-country agreement for each voie. using the `pairwise_cor` function.
...
```{r US_cors_map, dependson = c("world_data", "US_cors"), fig.width = 6, fig.height = 6}
US_cors %>%
...
Another useful kind of visualization is a network plot, with ggraph. We can filter for countries with correlations above a particular threshold.
